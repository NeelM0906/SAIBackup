...
```bash
cd /Users/samantha/.openclaw/workspace/tools/automation-servers/reporting-server
...
Based on: `/Users/samantha/.openclaw/workspace/memory/bi-hourly-questionnaire-v2.md`
