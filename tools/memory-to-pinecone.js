...
dotenv.config({ path: '/Users/samantha/.openclaw/workspace-forge/.env' });
...
async function main() {
  ...
  // Process MEMORY.md
  const memoryPath = '/Users/samantha/.openclaw/workspace/MEMORY.md';
  if (fs.existsSync(memoryPath)) {
    await upsertMemory(memoryPath, 'longterm');
  }
  
  // Process daily memory files
  const memoryDir = '/Users/samantha/.openclaw/workspace/memory';
