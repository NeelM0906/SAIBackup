...
try:
    ...
    with open('/Users/samantha/.openclaw/workspace-forge/memory/kai_night_output.txt', 'a') as f:
        f.write(f"\n--- {time.ctime()} ---\n")
        f.write(response.text)
except Exception as e:
    with open('/Users/samantha/.openclaw/workspace-forge/memory/kai_night_error.txt', 'a') as f:
